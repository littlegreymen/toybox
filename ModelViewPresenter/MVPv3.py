...
class TableView(QWidget):
    ...
    def __init__(self):
        ...
        self.table.setSortingEnabled(False)  # Disable default sorting; we'll handle it
    ...
    def set_horizontal_headers(self, headers):
        ...
        # Optional: stretch columns nicely
...
class TablePresenter:
    ...
    def sort_by_column(self, col):
        # Toggle ascending/descending if same column clicked repeatedly
...
if __name__ == '__main__':
    ...
    view.setWindowTitle("MVP Table - DOB & Age Example with Header Sorting")
    view.resize(900, 400)
    view.show()
    sys.exit(app.exec_())
